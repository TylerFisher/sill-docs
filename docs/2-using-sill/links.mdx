...
If you have [Sill+](../3-sill-plus) and have enabled lists from Bluesky or Mastodon, you can use this filter to see only items from a selected list. By default, Sill pulls in all of your lists as well as your home timeline into the same feed.